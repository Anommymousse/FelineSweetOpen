...
public class AnimateBalloon : MonoBehaviour
{
    //int _clickCount = 0;
    ...
    float _localRotZmax=0.2f;
    float _localRotZdir = 1.0f;
    float _localRotTimeToComplete = 5.0f;
    float _heighty;
    float _heightSpd = 0.05f;
    float _heightymax = 2.0f;
    float _heightDirection = 1.0f;
    float _localheightTimeToComplete = 5.0f;
    float _wibblexSpeed=0.1f;
    float _wibblex;
    float _wibblexMax = 1.0f;
    float _wibbleDirection = -1.0f;
    float _localwibbleTimeToComplete = 2.5f;
